			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">ເງິນຄືນ</h4>
						</div>
					</div>	
					<h6 class="text">ຮັບປະກັນເງີນຄືນ 30 ວັນ.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">ສົ່ງຟຣີ</h4>
						</div>
					</div>
					<h6 class="text">ການຂົນສົ່ງໂດຍບໍ່ເສຍຄ່າໃນໄລຍະ Rs. 600.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">ຂາຍພິເສດ</h4>
						</div>
					</div>
					<h6 class="text">ສິນຄ້າທຸກຢ່າງ - ຫຼຸດເຖິງ 20% </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">ສິນຄ້າແນະ ນຳ</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">ທັງໝົດ</a></li>
					<li><a href="#books" data-toggle="tab">ປື້ມ</a></li>
					<li><a href="#furniture" data-toggle="tab">ເຟີນີເຈີ</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					...
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">ເພີ່ມເຂົ້າກະຕ່າ</a></div>
			</div><!-- /.product -->
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">ໂທລະສັບມືຖື</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">ຄອມພີວເຕີ</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">ແຟຊັ່ນ</h3>
