	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				<li><a href="#">ໜ້າລັກ</a></li>
				<li class='active'>ເຊັກເອົ່າ</li>
			</ul>
...
<div class="form-group">
					    <label class="info-title" for="name">ຊື່<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="exampleInputEmail1">ທີ່ຢູ່ອີເມວ <span>*</span></label>
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Contact No.">ເບີໂທຕິດຕໍ່. <span>*</span></label>
...
<div class="form-group">
					    <label class="info-title" for="Current Password">ລະຫັດປະຈຸບັນ<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="New Password">ສະຫັດຜ່ານໃໝ່ <span>*</span></label>
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="Confirm Password">ຢືນຢັນລະຫັດຜ່ານ <span>*</span></label>
