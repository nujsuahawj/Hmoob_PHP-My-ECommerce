...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" placeholder="ຊອກຫາ..." name="product" required="required" />

            <button class="search-button" type="submit" name="ຄົ້ນຫາ"></button>    
...
if(!empty($_SESSION['cart'])){
	...
	?>
			...
			<div class="clearfix cart-total">
				...
				<a href="my-cart.php" class="btn btn-upper btn-primary btn-block m-t-20">ກະຕ່າຂອງທ່ານ</a>	
			</div><!-- /.cart-total-->
...
<div class="dropdown dropdown-cart">
		...
		<ul class="dropdown-menu">
			...
			<div class="clearfix cart-total">
				...
				<a href="index.php" class="btn btn-upper btn-primary btn-block m-t-20">ກັບສູ່ໜ້າລັກເພື່ອເລືອກສິນຄ້າ</a>	
			</div><!-- /.cart-total-->
