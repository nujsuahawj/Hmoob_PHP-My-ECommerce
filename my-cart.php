...
if(!empty($_SESSION['cart'])){
	?>
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item">ຖິ້ມ</th>
					<th class="cart-description item">ຮູບພາບ</th>
					<th class="cart-product-name item">ຊື່ສິນຄ້າ</th>
			
					<th class="cart-qty item">ຈຳນວນ</th>
					<th class="cart-sub-total item">ລາຄາ</th>
					<th class="cart-sub-total item">ລາຄາຂົນສົ່ງ</th>
					<th class="cart-total last-item">ລວມທັ່ງໝົດ</th>
				</tr>
			</thead><!-- /thead -->
			<tfoot>
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">ກັບສູໜ້າລັກເພື່ອເລືອກສິນຄ້າ</a>
								<input type="submit" name="submit" value="ອັບແດດກະຕ່າ" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">ທີ່ຢູ່ຂອງການຂົນສົ່ງ</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">ທີ່ຢູ່ໃບບິນ</span>
				</th>
			</tr>
		</thead>
		<tbody>
