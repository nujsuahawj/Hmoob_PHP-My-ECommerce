	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				<li><a href="home.html">ໜ້າລັກ</a></li>
				<li class='active'>ສິ່ງທີ່ມັກ</li>
			</ul>
...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			<thead>
				<tr>
					<th colspan="4">ສິ່ງທີ່ມັກຂອງຂ້ອຍ</th>
				</tr>
			</thead>
			<tbody>
<?php
...
?>
					...
					<td class="col-md-2">
						<a href="my-wishlist.php?page=product&action=add&id=<?php echo $row['pid']; ?>" class="btn-upper btn btn-primary">ເພີ່ມເຂົ້າກະຕ່າ</a>
					</td>
				...
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">ສິ່ງທີ່ມັກຂອງທ່ານບໍ່ມີຫຍັງ</td>
